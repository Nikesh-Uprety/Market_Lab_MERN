...
const Navbar = ()=>{
    ...
    <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item">
                <NavLink to="/signup" activeClassName="btnactive" className="nav-link custom-btn ">Signup</NavLink>
              </li>

              <li className="nav-item">
        <NavLink to="/login" activeClassName="btnactive" className="nav-link custom-btn ">Login</NavLink>
              </li>
