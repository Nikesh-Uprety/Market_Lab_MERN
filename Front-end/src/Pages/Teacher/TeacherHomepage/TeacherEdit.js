          ...
          data = (   <>
            ...
            <div className="Welcome-msg">
                    ...
                    <div className="Teacher-Courses-Buttons">
                      ...
                      <button onClick={() => this.categoryHandler("Stock Market")} className={classWeb.join(' ')} > Zero to Hero Trading Course</button>
                      <button className={classWebDesign.join(' ')} onClick={() => this.categoryHandler("Stock Market")}> Stock Market Mastery Course</button>
                      <button className={classReact.join(' ')} onClick={() => this.categoryHandler("Forex")}> Forex Fundamentals</button>
                      <button className={classML.join(' ')} onClick={() => this.categoryHandler("Forex")}> Road to Forex Funded Account</button>
                      <button className={classPhotography.join(' ')} onClick={() => this.categoryHandler("Commodity")}> Commodity Fundamentals</button>
                      <button className={classNodeJs.join(' ')} onClick={() => this.categoryHandler("Commodity")}> Commodity Elite Strategies</button>
